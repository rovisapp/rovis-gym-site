...
A private, on-device strength workout tracker for iPhone and Apple Watch.
...
Everything stays on your device. There's no account to create, no cloud sync, no friend feeds - just a tool for tracking what you did at the gym so next session you know what to beat.

## What's in the box

- Add exercises and log sets with weight + reps in a single screen.
- Live workout session with phase indicator (work / rest), set counter, configurable rest timer.
